...
class SessionProvider extends ChangeNotifier {
  ...
  String get listaPrecios => _listaPrecios;
  int? get listaPreciosCodigo => _listaPreciosCodigo;
  ...
  void setClienteData({
    ...
    _ciudad = ciudad.trim();
    _balance = balance;
    _listaPrecios = listaPrecios.trim();
    _listaPreciosCodigo = listaPreciosCodigo;
    notifyListeners();
  }
