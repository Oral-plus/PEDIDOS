...
class _CartBottomSheetState extends State<CartBottomSheet>
  ...
  Widget _entrance(String id, Widget child) {
    ...
    return TweenAnimationBuilder<double>(
      ...
      builder: (_, t, ch) => Opacity(
        ...
        child: Transform.translate(offset: Offset(0, (1 - t) * 24), child: ch),
      ),
      child: child,
    );
  }
  ...
  Widget _buildCartItems(CartProvider cartProvider) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _entrance(item.id, _buildCartItem(cartProvider, item));
      },
    );
  }
        ...
        child: Column(
          ...
          children: [
            TweenAnimationBuilder<double>(
              ...
              curve: Curves.easeOutBack,
              builder: (_, t, child) => Transform.scale(scale: t.clamp(0.0, 1.0), child: child),
              child: Container(
                width: 80,
                height: 80,
                decoration: BoxDecoration(
      ...
      background: Container(
        ...
        child: const Row(
          ...
          children: [
            ...
            SizedBox(width: 6),
            Text('Eliminar', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
          ],
        ),
      ),
      child: _buildCartItemBody(cartProvider, item),
    );
  }

  Widget _buildCartItemBody(CartProvider cartProvider, CartItem item) {
    return Container(
      margin: const EdgeInsets.only(bottom: 12),
  ...
  Widget _footerPriceRow(String label, String value, bool bold, {bool animate = false}) {
